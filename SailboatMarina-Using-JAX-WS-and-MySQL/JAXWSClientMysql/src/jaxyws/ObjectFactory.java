 ...
 * generated in the jaxyws package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://jaxyws/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://jaxyws/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxyws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxyws/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxyws/", name = "helloWorldResponse")
