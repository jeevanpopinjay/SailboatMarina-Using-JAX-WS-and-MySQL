 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://jaxyws/", wsdlLocation = "http://localhost:8007/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://jaxyws/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://jaxyws/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxyws/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
